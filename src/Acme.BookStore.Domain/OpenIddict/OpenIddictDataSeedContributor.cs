 ...
 */
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var appClientId = configurationSection["BookStore_App:ClientId"];
        if (!appClientId.IsNullOrWhiteSpace())
        {
            var appClientRootUrl = configurationSection["BookStore_App:RootUrl"]?.TrimEnd('/');
